...
public class CallsAdapter extends BaseAdapter<CallsAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        tagView(holder.itemView, Integer.toString(position), mCursor.getString(ClassesLoader.Query._ID), mCursor.getString(CallsLoader.Query.COLUMN_CLASS_ID), mCursor.getString(CallsLoader.Query
                .COLUMN_DATETIME));
    }
    ...
    private void tagView(View v, String position, String callId, String classId, String callDate){
