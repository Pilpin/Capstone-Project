...
public class StudentsAdapter extends BaseAdapter<StudentsAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        tagView(holder.itemView, Integer.toString(position), mCursor.getString(StudentsLoader.Query._ID), mCursor.getString(StudentsLoader.Query.COLUMN_FIRSTNAME), mCursor.getString(StudentsLoader
                .Query.COLUMN_LASTNAME), mCursor.getString(StudentsLoader.Query.COLUMN_BIRTHDATE));
    }
