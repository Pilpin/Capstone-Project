...
public class ClassStudentsAdapter extends RecyclerView.Adapter<ClassStudentsAdapter.ViewHolder> {
    private Cursor mCursor;
    private Context mContext;

    public ClassStudentsAdapter(Context context, Cursor cursor) {
        mCursor = cursor;
        mContext = context;
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        String age_grade = mContext.getResources().getString(R.string.age_to_string, age) + " - " + mCursor.getString(StudentsLoader.Query.COLUMN_GRADE);
